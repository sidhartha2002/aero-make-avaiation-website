...
export const OtherVisual = ({ id }: Props) => {
  const textArray = [
    [
      ...
      "Your Trusted Partner for Aircraft Materials",
      "Our unwavering commitment is to deliver excellence in aircraft materials supply, setting the standard for quality and performance in the aviation industry.",
    ],
    [
    ...
    [
      "Elevating Aviation Excellence",
      "- IDGs- Pneumatic Valves- Wheels & Brakes",
      "Our inventory comprises a vast selection of ready to-use key rotables, encompassing Airframe, Engine, and components for various aircraft platforms",
    ],
    [
      "Elevating Aviation Excellence",
      "Your Trusted Partner for Aircraft Materials",
      "- General & Special Hand Tools- Aircraft Structure Tools- Ground Support Equipment- Engine Stands",
    ],
    [
      "Elevating Aviation Excellence",
      "Your Trusted Partner for Aircraft Materials",
      "- Lubricants and oils- Adhesives and sealants- Nuts and bolts- Cleaning compounds and chemicals",
    ],
  ];
  ...
  return (
    <Visual id={id}>
      {/* <img src="/window-spotify.webp" /> */}
      <div className="w[1] h-[90vh] w-[90vw] rounded-2xl bg-black p-8 text-white">
        <div className="text-4xl">{textArray[parseInt(id)][0]}</div>
        <br />
        <div className="text-3xl text-gray-500">
          {textArray[parseInt(id)][1]}
        </div>
        <br />
        <br />
        <div>{textArray[parseInt(id)][2]}</div>
      </div>
    </Visual>
  );
};
