  ...
  return (
    ...
    >
      {/* <img
        ...
        src="https://media.istockphoto.com/id/917911572/photo/standing-woman-on-the-hill-against-mountain-valley-at-bright-sunny-day-landscape-with-girl.jpg?s=2048x2048&w=is&k=20&c=cM_JXt2TA5RkUwemBr30OYs_v_Wz2KaQD-Lze6Koz88="
        alt=""
      /> */}
      <div
        className={classNames(
...
export const Todo = ({ id }: CardProps) => {
  return (
    <FeatureCard id={id} gradient="gradient-0">
      <span />
      {/* <div className="h-full w-full rounded-2xl bg-red-500 opacity-50">
        insideGFeatureCard Show More
      </div> */}
    </FeatureCard>
  );
};
