...
export const Pages = () => {
  ...
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      const items = [];
      [...document.querySelectorAll(".parts-content .parts-item")].forEach(
        (item) => {
      ...
      if (menu) {
        ...
        if (menu === "Services" || menu === "Quality") {
          ...
          const headingItems = [];
          [
            ...document.querySelectorAll(".heading__anim .mask-split-line"),
          ].forEach((item) => {
          ...
          [
            ...document.querySelectorAll(
              ".heading__noanim.first .mask-split-line .char"
            ),
          ].forEach((item) => {
  ...
  return (
    <div ref={pageRef} onClick={() => setMenu(null)}>
      <div
        id="aboutPage"
        ref={aboutPageRef}
        className={`panels ${menu && menu === "About" ? "show" : ""}`}
      >
        ...
        <div className="parts-content">
          <figure className="parts-item">
            <figcaption className="parts-item__caption">
              ...
              <p className="parts-item__caption-description">
                Aeromake Aviation, a stalwart in the aviation industry with
                decades of experience, has established itself as a distinguished
                provider of comprehensive aircraft materials support services.
                With a relentless commitment to excellence, Aeromake Aviation
                has navigated the dynamic and demanding aviation landscape,
                emerging as a trusted partner for a global clientele.
              </p>
            </figcaption>
          </figure>
          <figure className="parts-item">
          ...
          <figure className="parts-item">
            <figcaption className="parts-item__caption">
              ...
              <p className="parts-item__caption-description">
                ...
                inventory and top-tier component services. Their comprehensive
                offerings are designed to ensure that the wheels of aviation
          ...
          <figure className="parts-item">
            <figcaption className="parts-item__caption">
              ...
              <div className="parts-item__caption-description">
                ...
                innovative approaches empower clients to achieve unprecedented
                levels of operational efficiency and excellence, driving them
          ...
          <figure className="parts-item">
            <figcaption className="parts-item__caption">
              ...
              <div className="parts-item__caption-description">
                Aeromake Aviation recognizes the pivotal role of reliable and
                efficient spares support in aviation operations. To this end,
                the company offers tailored solutions that are meticulously
                crafted to meet the specific needs of each client. Their team of
                seasoned professionals possesses in-depth knowledge and
                expertise, enabling them to optimize operational efficiency,
                minimize downtime, and maximize cost-effectiveness.
              </div>
            </figcaption>
          </figure>
          <figure className="parts-item">
            <figcaption className="parts-item__caption">
              ...
              <div className="parts-item__caption-description">
                ...
                direct contact, prompt support, instant communication, low lead
                times, and competitive pricing, all contributing to a seamless
      ...
      <div
        id="partsPage"
        ref={partsPageRef}
        className={`panels ${menu && menu === "Parts" ? "show" : ""}`}
      >
        <div className="heading">
        ...
        <div className="parts-content">
          <figure className="parts-item">
            <figcaption className="parts-item__caption">
              ...
              <p className="parts-item__caption-description">
                Our unwavering commitment is to deliver excellence in aircraft
                materials supply, setting the standard for quality and
          ...
          <figure className="parts-item">
            <figcaption className="parts-item__caption">
              ...
              <p className="parts-item__caption-description">
                Aeromake Aviation stands out by consistently providing the
                highest quality products at the most competitive prices. Our
                pride lies in the exceptional customer service we offer and our
                lightning-fast order fulfillment. We are committed to ensuring a
          ...
          <figure className="parts-item">
            <figcaption className="parts-item__caption">
              ...
              <div className="parts-item__caption-description">
                ...
                Our inventory comprises a vast selection of ready to-use key
                rotables, encompassing Airframe, Engine, and components for
      ...
      <div
        id="servicesPage"
        ref={servicesPageRef}
        className={`panels ${menu && menu === "Services" ? "show" : ""}`}
      >
        <div
          id="slider1-container"
        ...
        >
            ...
            >
              ...
              >
                <span style={{ display: "block", fontSize: 20 }}>
                  Ensuring the optimal functionality of your aircraft parts is
                  our unwavering commitment. We take pride in the meticulous
                  approach we employ to repair your components to precise
                  specifications, always meeting your specific requirements for
                  turnaround times. Our dedicated team goes above and beyond,
                  carefully selecting a qualified repair facility from our
                  extensive network of vendors. This meticulous vetting process
                  is integral to our promise of delivering high-quality service.
                </span>
              </div>
            </h2>
            <h2
          ...
          <div className="panel TextSection_text-section">
            ...
            >
              ...
              >
                Our service extends comprehensively across all ATA chapters,
                covering Airframe, Engines, Auxiliary Power, Landing Gear,
                Avionics, Structural, and Safety Equipment. We place a strong
                emphasis on service excellence, offering swift turnaround times,
                competitive pricing solutions, and aiming for unparalleled
                levels of customer satisfaction. Your peace of mind is our
                priority, and we strive to deliver on our promises with
          ...
          <div className="panel TextSection_text-section">
            ...
            >
              ...
              >
                By choosing us as your sole point of contact, you gain the
                advantage of a consolidated vendor management process. This
                strategic decision alleviates concerns on your end, allowing you
                to focus on other priorities with confidence. We aim to
                streamline the repair and maintenance process for you, providing
                not just a service but a partnership built on trust, efficiency,
      ...
      <div
        id="qualityPage"
        ref={qualityPageRef}
        className={`panels ${menu && menu === "Quality" ? "show" : ""}`}
      >
        <div
        ...
        >
          <div className="panel TextSection_text-section">
            ...
            >
              ...
              >
                Empowering airline operators to unlock the full potential of
                their aircraft fleet through exceptional precision aftermarket
                solutions
              </div>
            </h2>
          </div>
          <div className="panel TextSection_text-section">
            ...
            >
              ...
              >
                Our mission is to revolutionize the aviation aftermarket support
                industry. We strive to be the premier provider of a
                comprehensive range of high-quality aircraft consumables,
          ...
          <div className="panel TextSection_text-section">
            ...
            >
              ...
              >
                We are committed to supplying the aviation industry with
                reliable and efficient solutions that meet their operational
          ...
          <div className="panel TextSection_text-section">
            ...
            >
              ...
              >
                Through our unwavering dedication to excellence, we aim to
                ensure the smooth and safe operation of aircraft by delivering
                superior products and exceptional service.
              </div>
            </h2>
          </div>
          <div className="panel TextSection_text-section">
            ...
            >
              ...
              >
                With a focus on customer satisfaction, innovation, and industry
                expertise, we strive to be the trusted partner for all aviation
                supply requirements.
              </div>
            </h2>
          </div>
          <div className="panel TextSection_text-section">
            ...
            >
              ...
              >
                Through relentless innovation, we develop ground breaking
                solutions that address the unique challenges faced by customers,
                enabling them to achieve unprecedented levels of operational
                excellence.
              </div>
            </h2>
          </div>
