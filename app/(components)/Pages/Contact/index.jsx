...
export const Contact = () => {
  ...
  return (
    <div
      id="contactPage"
      className={`${menu && menu === "Contact" ? "open" : ""}`}
      onClick={(e) => {
        if (
          !["INPUT", "TEXTAREA", "BUTTON", "SPAN"].includes(e.target.tagName)
        ) {
          setMenu(null);
        }
      }}
    >
      <div className="pt-36 d-flex flex-wrap flex-lg-nowrap">
        <div className="fs-2xl mx-auto pl-lg-8 title">
        ...
        <div className="w-full pl-lg-8 my-12">
          <div className="container">
            <form data-hs-cf-bound="true">
              <h1 className="text-center mb-12 d-lg-none">Get in touch</h1>
              <div className="d-flex flex-wrap flex-lg-nowrap">
                ...
                />
                <input
                  className="form-control flex-grow-1 ml-lg-4 mt-8 mt-lg-0"
              ...
              ></textarea>
              <button
                className="btn position-relative btn-black mt-8 w-full text-center"
                type="submit"
              >
                <span>Send request for contact</span>
              </button>
            </form>
          </div>
        </div>
