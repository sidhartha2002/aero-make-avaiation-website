  ...
  return (
    <header className="position-relative">
      <nav className="navbar w-full position-relative theme-light">
        <div className="desktop-menu position-fixed top-0 left-0 right-0 bg-white border-bottom pointer-events-nonee">
        ...
        <div className="navbar-fixed position-fixed w-full">
          <div className="row justify-content-between align-items-center">
            ...
            <div className="col-2 d-flex justify-content-end">
              ...
              <span className="">
                <a
                  className="d-none d-lg-block fs-lg nav-link-item"
                  href="#"
